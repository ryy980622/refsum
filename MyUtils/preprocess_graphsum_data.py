...
if __name__ == '__main__':
    ...
    parser.add_argument("-json_path", default='../Data/s2orc_data_tfidf_json')
    parser.add_argument("-data_path", default='..\\Data\\s2orc_data_tfidf_paddle')
    parser.add_argument("-vocab_path", default='../vocab/spm9998_3.model')

    parser.add_argument("-train_src", default='../Data/delve_processed_01/train.src')
    parser.add_argument("-train_tgt", default='../Data/delve_processed_01/train.tgt')
    parser.add_argument("-valid_src", default='../Data/delve_processed_01/val.src')
    parser.add_argument("-valid_tgt", default='../Data/delve_processed_01/val.tgt')
    parser.add_argument("-test_src", default='../Data/delve_processed_01/test.src')
    parser.add_argument("-test_tgt", default='../Data/delve_processed_01/test.tgt')
