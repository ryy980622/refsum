...
from src.utils.check import check_gpu
from src.models.neural_modules import position_encoding_init
from src.tools.cal_rouge import test_rouge, rouge_results_to_str
from src.utils.bleu import compute_bleu

import src.networks.graphsum.graphsum_reader as task_reader
from src.networks.graphsum.graphsum_model import GraphSumConfig, GraphSumModel
from src.optimize.optimization import optimization
from src.utils.init import init_pretraining_params, init_checkpoint
from src.utils.args import print_arguments
from src.networks.graphsum.graphsum_args import parser
...
def main(args):
    ...
    if args.do_train:
        ...
        print('trainer_num:', trainers_num)
    ...
    if args.do_train:
        ...
        print('num_threads:', dev_count)
        print('exec_strategy:', exec_strategy)
        print('nccl2_num_trainers:', nccl2_num_trainers)
