...
def main_test():
    ...
    parser.add_argument("-use_fast_executor", default=True)
    ...
    parser.add_argument("-batch_size", default=514)
    parser.add_argument("-in_tokens", default=True)
    parser.add_argument("-stream_job", default=None)
    ...
    parser.add_argument("-test_set",
                        # default="/home/ryy/code/NLP/20220308/Data/MyData/my_data_tfidf_paddle/MyData.100.my_data_tfidf_json")
                        default="/home/ryy/code/NLP/20220308/Data/MyData/my_data_tfidf_paddle")
    ...
    parser.add_argument("-init_checkpoint",
                        default="/home/ryy/code/NLP/20220308/Log/models/step_110000")
    ...
    parser.add_argument("-max_tgt_len", default=800)
    parser.add_argument("-max_out_len", default=800)
    parser.add_argument("-min_out_len", default=300)
    ...
    parser.add_argument("-report_rouge", default=False)
    ...
    parser.add_argument("-log_file", default="/home/ryy/code/NLP/20220308/Log/log/graphsum_delve_test.log")
    ...
    parser.add_argument("-decr_every_n_nan_or_inf", default=2.0)
    parser.add_argument("-incr_ratio", default=2.0)
    parser.add_argument("-decr_ratio", default=0.8)
    parser.add_argument("-beta1", default=0.9)
    parser.add_argument("-beta2", default=0.998)
    parser.add_argument("-eps", default=1e-9)

    parser.add_argument("-evaluate_blue", default=False)
